        ...
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-6 lg:p-8 border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-8">
            ...
            <div className="flex gap-3">
              ...
              >
                {isLoading ? "Mengubah..." : "Update Password"}
              </motion.button>
            </div>
          </form>
        </div>
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-3.5 lg:py-4 rounded-xl border-2 border-[#D291BC]/10 focus:border-[#D291BC] focus:ring-2 focus:ring-[#D291BC]/20 transition-all text-[#D291BC] bg-white/60 placeholder-[#D291BC]/40 pr-12 font-medium text-sm lg:text-base disabled:opacity-50 disabled:cursor-not-allowed"
          value={value}
        ...
        <button
          ...
          disabled={disabled}
          className="absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-lg text-[#D291BC]/60 hover:text-[#D291BC] hover:bg-[#FFE3EC]/50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {showPassword ? (
