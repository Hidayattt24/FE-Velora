...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative h-full w-[300px] shrink-0 cursor-pointer overflow-hidden rounded-xl border p-4",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            Dengarkan pengalaman para ibu yang telah menggunakan Velora dalam perjalanan kehamilannya
          </p>
        </div>
        ...
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden gap-8">
          ...
          <Marquee reverse className="[--duration:35s] [--gap:1rem]" pauseOnHover>
            {[...reviews, ...reviews].map((review, index) => (
              <ReviewCard key={`${review.username}-${index}`} {...review} />
            ))}
          </Marquee>
